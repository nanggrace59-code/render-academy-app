...
function StudentWorkspace({ user, setUser }: { user: Profile, setUser: (u: Profile) => void }) {
    ...
    if (!user.references?.interior || !user.references?.exterior) {
        return (
            <div className="w-full h-screen flex flex-col items-center justify-center p-6 bg-[#050505] overflow-auto">
    ...
    return (
        <div className="flex w-full h-screen bg-[#050505] overflow-hidden">
            ...
            {/* --- 1. LEFT SIDEBAR (The Specific Layout You Wanted) --- */}
            <div className="w-20 bg-[#0a0a0a] border-r border-white/5 flex flex-col items-center py-6 shrink-0 z-50">
                 ...
                 <div className="flex flex-col gap-6 items-center w-full">
                    {/* Workspace Button (Active White Box) */}
                    <button 
                 ...
                 {/* Spacer to push next items to bottom */}
                 ...
                 <div className="flex flex-col gap-4 items-center">
                    ...
                    <button onClick={() => { localStorage.removeItem('activeUserEmail'); window.location.href = '/login'; }} className="w-10 h-10 rounded-full border border-white/5 flex items-center justify-center text-neutral-500 hover:bg-[#d90238] hover:border-[#d90238] hover:text-white transition-all" title="Logout">
                        <LogOut size={16}/>
                    </button>
                 </div>
            </div>
            ...
            <div className="flex-1 flex flex-col relative min-w-0">
                ...
                {/* HEADER (Clean - Only Text) */}
                <header className="h-20 border-b border-white/5 bg-[#050505] flex items-center justify-between px-8 shrink-0 z-40">
                     <div>
