...
import { ImageSlider } from '@/components/ImageSlider'; // Comparison Tool
import { 
                ...
                <div className="w-[380px] bg-[#0a0a0a] border-l border-neutral-800 flex flex-col shrink-0 z-10 shadow-[-10px_0_30px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="flex-1 flex flex-col p-6 bg-gradient-to-b from-[#0a0a0a] to-[#050505]">
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-auto">
                            <button onClick={handleReject} className="h-12 rounded-sm border border-red-900/30 bg-red-950/5 hover:bg-red-900/20 text-red-600 hover:text-red-500 transition-all font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2"><X size={16}/> Reject</button>
                            <button onClick={handleApprove} className="h-12 rounded-sm bg-emerald-700 hover:bg-emerald-600 text-white shadow-lg hover:shadow-emerald-900/30 transition-all font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2"><Check size={16}/> Approve</button>
                        </div>
                    </div>
                </div>
            </div>
