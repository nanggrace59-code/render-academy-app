...
export default function TeacherDashboard() {
    ...
    // --- SMART FILTERING ---
    // Fixes the issue where "Master Class" vs "master_class" caused assignments to hide
    const filteredSubmissions = submissions.filter(sub => {
        const studentClass = sub.profiles?.enrolled_class?.toLowerCase() || '';
        if (selectedClass === 'master_class') {
            return studentClass.includes('master'); // Checks if name contains "master"
        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans flex flex-col">
            ...
            <header className="h-16 border-b border-white/10 flex items-center justify-between px-8 bg-[#0a0a0a] shrink-0">
                ...
                <button 
                    ...
                    className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-neutral-500 hover:text-white transition-colors border border-white/10 px-4 py-2 rounded-full hover:bg-white/5"
                >
                    ...
                    <div className="w-full max-w-4xl flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <button 
                                ...
                                className="group bg-[#0a0a0a] border border-white/10 rounded-xl p-6 text-left hover:border-[#d90238] transition-all hover:bg-[#d90238]/5 flex items-center gap-6"
                            >
                        ...
                        <div className="bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden min-h-[400px]">
                            ...
                            {loading ? (
                                ...
                                <div className="p-12 text-center">
                                    ...
                                    <p className="text-neutral-700 text-xs mt-2">Wait for students to upload their work.</p>
                                </div>
                            ) : (
